...
namespace CmsShoppingCart.Areas.Admin.Controllers
{
    public class ShopController : Controller
    {
        ...
        public ActionResult Products(int? page, int? cateId)
        {
            ...
            using (Db db = new Db())
            {
                ...
                listOfProductVM = db.Products.ToArray()
                                    .Where(x => cateId == null || cateId == 0 || x.CategoryId == cateId)
                ...
                ViewBag.SelectedCate = cateId.ToString();
            }
            // Set pagination
        ...
        public ActionResult EditProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            // Populate dategories select list and gallery images
            using (Db db = new Db())
            {
                model.Categories = new SelectList(db.Categories.ToList(), "Id", "Name");
            }
            ...
            if (file != null && file.ContentLength > 0)
            {
                ...
                DirectoryInfo direct1 = new DirectoryInfo(pathString1);
                DirectoryInfo direct2 = new DirectoryInfo(pathString2);

                foreach (FileInfo file2 in direct1.GetFiles())
                    file2.Delete();

                foreach (FileInfo file3 in direct2.GetFiles())
                    file3.Delete();
